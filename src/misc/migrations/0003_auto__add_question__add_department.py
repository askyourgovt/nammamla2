...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'misc_question', (
            ...
            ('department', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['misc.Department'])),
        ...
        db.send_create_signal(u'misc', ['Question'])

        # Adding model 'Department'
        db.create_table(u'misc_department', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'misc', ['Department'])


    def backwards(self, orm):
        # Deleting model 'Question'
        db.delete_table(u'misc_question')

        # Deleting model 'Department'
        db.delete_table(u'misc_department')
